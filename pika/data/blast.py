...
def get_homologues_from_train_set(
    ...
    command = (
        f"blastp -query {query_file_name} -db {blast_db} "
        f'-out {save_path} -outfmt "6 qseqid sseqid score" -num_threads 128'
    )
...
if __name__ == "__main__":
    get_homologues_from_train_set(
        ...
        split_path="seed_1.csv",
        split="test",
        blast_db="blast_db/Pika_blast_db",
        out_path="evo_split_homology_test.pkl",
